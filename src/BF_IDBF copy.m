function F = BF_IDBF(fun_org,xx,kk,nn,rk,tol,rand_or_cheb,opt)
...
if nargin < 7, rand_or_cheb = 'cheb'; end
if nargin < 8, opt = 1; end % 1: adaptive rank; 0: exact rank=rk
        ...
        for b = 1:nb                             % loop over blocks
            ...
            if ~cheat || b == 1
                switch rand_or_cheb
                    ...
                    case 'rand'
                        [T,sk,~,rd] = BF_ID_rand(fun,ri(:),ci(:),rk,tol,'r',opt);
                end
            end
        ...
        for b = 1:nb                             % loop over blocks
            ...
            if ~cheat || b == 1
                switch rand_or_cheb
                    ...
                    case 'rand'
                        [T,sk,~,rd] = BF_ID_rand(fun,ri(:),ci(:),rk,tol,'c',opt);
                end
            end
